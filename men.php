        ...
        <div class="result-area">
            <div class="related-cat">
                ...
                <h3>Related Categories</h3>
                    <ul>
                        <li><a href="men.php">All Products</a></li>
                        <?php 
            ...
            <div class="search-items">
                <section id="product1">
                    ...
                    <?php
                    $menQuery = "SELECT products.product_id, products.product_title, products.product_code, products.product_price, products.product_img, products.product_cat, products.product_sub_cat, sub_categories.sub_cat_id, sub_categories.sub_cat_title FROM products, sub_categories WHERE products.product_sub_cat = sub_categories.sub_cat_id AND products.product_cat = '11' ORDER BY products.product_id DESC";

                    $result = mysqli_query($connect, $menQuery) or die(mysqli_error($connect));
                    while ($rows = mysqli_fetch_assoc($result)) 
                    {
                    ?>
                        <div class="pro">
