<!-- Navigation Bar -->
    ...
    <!-- Top Banner Section -->
    <section id="shop-header" class="kids-header"></section>
    ...
    <section id="search-result" class="section-pad1">
        <div class="result-area">
            <div class="related-cat">
                ...
                <h3>Related Categories</h3>
                    <ul>
                        <li><a href="kids.php">All Products</a></li>
                        <?php 
        ...
        <?php
        $kidsQuery = "SELECT products.product_id, products.product_title, products.product_code, products.product_price, products.product_img, products.product_cat, products.product_sub_cat, sub_categories.sub_cat_id, sub_categories.sub_cat_title FROM products, sub_categories WHERE products.product_sub_cat = sub_categories.sub_cat_id AND products.product_cat = '13' ORDER BY products.product_id DESC";
        $result = mysqli_query($connect, $kidsQuery) or die(mysqli_error($connect));
