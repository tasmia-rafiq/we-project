...
<?php include 'header.php'; ?>
    ...
    <!-- Top Banner Section -->
    <section id="shop-header" class="women-header">
    </section>
            ...
            <div class="search-items">
                <section id="product1">
                    <div class="pro-container">
                        ...
                        $women_sub_Query = "SELECT products.product_id, products.product_code, products.product_title, products.product_price, products.product_img, products.product_cat, products.product_sub_cat, sub_categories.sub_cat_id, sub_categories.sub_cat_title FROM products, sub_categories WHERE products.product_sub_cat = sub_categories.sub_cat_id AND products.product_sub_cat = '{$cat}' OR products.product_cat = '{$cat}' ORDER BY products.product_id DESC";

                        $result3 = mysqli_query($connect, $women_sub_Query) or die(mysqli_error($connect));
